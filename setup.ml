...
(* OASIS_START *)
(* DO NOT EDIT (digest: 67c2cb933d479b10d979d2ce355fda10) *)
(*
...
let setup_t =
  {
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("sudo", ["$test"]))];
               ...
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_findlib_name = Some "mirage-net-unix";
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("lwt.unix", None);
                           InternalLibrary "mirage-net-unix";
     ...
     oasis_version = "0.4.6";
     oasis_digest = Some "\237\027\014*\248\241\216Gj\0314M~\164 8";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
